        ...
        >
            ...
            >
                <span>
                    ...
                    <h1 className="text-sm font-semibold italic text-gray-800">{isCollapsed ? `${length} posts | ` : "" }{`Latest: ${convertDateToText(lastUpdate.date)} - ${extractName(lastUpdate.id)}`}</h1>
                </span>
            </div>
            {!isCollapsed && (
                <div>

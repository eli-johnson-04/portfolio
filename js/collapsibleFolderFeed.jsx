        ...
        >
            ...
            >
                <span>
                    ...
                    <h1 className="text-sm font-semibold italic text-gray-800">{isCollapsed ? `${length} post${length == 1 ? "" : "s"} | ` : "" }{`Latest: ${convertDateToText(lastUpdate.date)} - ${extractName(lastUpdate.id)}`}</h1>
                </span>
            </div>
            {!isCollapsed && (
                <div>

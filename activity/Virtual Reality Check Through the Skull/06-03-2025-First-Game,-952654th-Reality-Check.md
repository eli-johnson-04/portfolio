...
###### I'm not sure how good a practice it is to have my candles as actual children of another singular component, but it works for now. This just makes it so easy. Unity's ECS system is great.
...
###### Those candles in the back are static and not controlled by the Candle Manager. 
...
To my surprise and thorough satisfaction, it works! It feels like actual magic! Look!
...
This experience was spawned from starting this one arcade-style idea I had, and realizing that the first game that I had crazy ideas for before that was the one I really wanted to make. Lots of cool mechanics, a world, enemy factions with infighting, interlocking player attribute systems, a skill tree, and crazy, unbelievable art. **I do not have the ability to do justice to this vision.** So, I can make something with the same tone and atmosphere to build up my skills while basking in the same phantasmagoric headspace as that pseudo dream game.
